...
Usage: 
      $ uv run python process_pdf.py s3://temporal-dev/files/Mahmoud_Abdulhamid.pdf
"""
import os
import sys
import tempfile
...
def parse_s3_path(s3_path:str):
    ...
    """partition return 3 value bucket and _ contaitn / and key """
...
if __name__=="__main__":
    """ the first argument you type after the script name.
        ex python pdf_processor.py s3://my-bucket/documents/invoice.pdf 
        sys.argv[0] = "process_pdf.py" (The script name)
            sys.argv[1] = "s3://temporal-dev/files/cisco-88xx-user-guide.pdf" (The S3 path you provided)
    """
